...
import com.beer.utils.JsonConvertionUtils;
...
import static com.beer.utils.JsonConvertionUtils.*;
...
public class BeerControllerTest {
    ...
    void whenPATCHIsCalledToDEcrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception {
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(BeerStockDecreaseException.class);
